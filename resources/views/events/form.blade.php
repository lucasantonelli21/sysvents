                        ...
                        <div class="imageInfo p-1 ">
                            <div class="imageEvent ">
                                <label for="image_path">
                                    <img id = "output" src="{{ $event->image_path ? asset($event->image_path) : asset('images/default-image.jpg') }}" class="rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="editImageIcon bi bi-pencil-square" viewBox="0 0 16 16">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input name = "image_path" id = "image_path" class ="form-control" type="file" name="image_path" id ="image_path"
