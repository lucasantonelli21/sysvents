...
<x-blank>
    ...
    <div class="card">
        <div class="card-header bg-dark text-light text-end">
            ...
            <a href="{{ route('events.create') }}" class="btn btn-primary"> Adicionar Eventos
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <form action="{{ route('events.index') }}">
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    <a type="button" class="btn btn-light" href="{{ route('events.index') }}">Limpar
                                        Filtro</a>
    ...
    <div class="card-body bg-dark ">
        <div class="table-responsive ">
            <table class="table-events table table-bordered table-dark">
                <tr>
                    <th>Nome</th>
                    <th>Tema</th>
                    <th>Descrição</th>
                ...
                @foreach ($events as $event)
                    <tr>
                        ...
                        <td class='theme-cell'>{{ $event->theme }}</td>
