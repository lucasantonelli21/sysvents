...
=======
            <h2 class="title text-center">Tipos de Ingresso do Evento {{ $event->name }}</h2>
            <a href="{{ route('events.tickets.types.register', $event->id) }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-plus-square" viewBox="0 0 16 16">
                    <path
                        d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" />
...
=======
                                    <a href="{{ route('events.tickets.types.edit', [$event->id, $ticketType->id]) }}"
>>>>>>> Stashed changes
...
=======
                                    <form action="{{ route('events.tickets.types.delete',[$event->id,$ticketType->id]) }}" method="POST">
>>>>>>> Stashed changes
                                        @csrf
                                        @method('DELETE')
