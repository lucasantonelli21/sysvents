...
Route::prefix('/eventos')->name('events.')->group(function() {
    ...
    Route::post('/inscrição',       [EventController::class, 'inscrição']);
});
...
Route::prefix('/painel')->name('panel.')->middleware(VerifyLogin::class, AuthenticateRoutes::class)->group(function () {
    ...
    Route::prefix('/eventos')->name('events.')->group(function() {
        ...
        Route::prefix('{eventId}/ingressos')->name('tickets.')->group(function () {
            ...
            Route::prefix('/tipos')->name('types.')->group(function () {
                ...
                Route::prefix('/{ticketTypeId}/lotes')->name('batches.')->group(function () {
                    Route::get('/',                     [TicketBatchController::class, 'index'])->name('index');
                    Route::get('/criar',                [TicketBatchController::class, 'createOrEdit'])->middleware(VerifyLogin::class, AuthenticateRoutes::class)->name('register');
    ...
    Route::prefix('/transações')->name('transactions.')->group(function() {
        ...
        ROute::get('/{id}/info',        [TransactionController::class, 'showTransaction'])->name('show');
